...
export const connections = [
  {
    ...
    auth_reference: "projects/acme-prod/secrets/sendgrid-admin/versions/3",
    ...
    allowed_resources: ["sendgrid:api-keys:*"],
    http: {
  ...
  },
  {
    ...
    auth_reference: "workload-identity://firekey-secret-writer",
  ...
  },
  {
    ...
    auth_reference: "workload-identity://firekey-runtime-operator",
    capabilities: ["runtime.deployCandidate", "runtime.shiftTraffic", "runtime.rollback", "runtime.invokeCandidateProbe"],
    allowed_resources: ["projects/acme-prod/locations/us-central1/services/*"],
    http: null,
    status: "ready",
    region: "us-central1",
    created_at: earlier,
  ...
  },
  {
    ...
    auth_reference: "oauth://github/acme-security",
  ...
  },
  {
    ...
    auth_reference: "workload-identity://firekey-verifier",
  ...
  },
  {
    ...
    auth_reference: "projects/acme-prod/secrets/vendor-session/versions/6",
...
export const services = [
  ...
  { id: "svc_reconcile", organisation_id: "org_acme", application_id: "app_billing", environment_id: "env_billing_prod", runtime_connection_id: "conn_runtime", runtime_resource: "projects/acme-prod/locations/us-central1/jobs/reconciliation", display_name: "reconciliation-job", repository: "github.com/acme/billing", identity: "reconciliation@acme-prod.iam.gserviceaccount.com", created_at: earlier, updated_at: now, revision: 1 },
  ...
  { id: "svc_exports", organisation_id: "org_acme", application_id: "app_data", environment_id: "env_data_prod", runtime_connection_id: "conn_runtime", runtime_resource: "projects/acme-prod/locations/us-east4/jobs/warehouse-export", display_name: "warehouse-export", repository: "github.com/acme/warehouse", identity: "warehouse-export@acme-prod.iam.gserviceaccount.com", created_at: earlier, updated_at: now, revision: 1 },
]

export const credentials = [
  { id: "cred_sendgrid", organisation_id: "org_acme", connection_id: "conn_sendgrid", provider: "sendgrid", kind: "api-key", display_name: "production-password-emailer", provider_id: "sg_key_4902", scopes: ["mail.send"], consumer_ids: ["svc_notifications"], active_generation_id: "gen_sendgrid_7", policy_version: "policy_prod_v3", playbook_version: "play_sendgrid_v3", created_at: "2026-05-18T10:00:00Z", updated_at: now, revision: 8 },
  { id: "cred_stripe", organisation_id: "org_acme", connection_id: "conn_secrets", provider: "stripe", kind: "api-key", display_name: "stripe-checkout-live", provider_id: "rk_live_8184", scopes: ["charges.write", "customers.read"], consumer_ids: ["svc_checkout", "svc_webhooks"], active_generation_id: "gen_stripe_5", policy_version: "policy_prod_v3", playbook_version: "play_stripe_v2", created_at: "2026-06-14T10:00:00Z", updated_at: "2026-08-15T15:20:00Z", revision: 5 },
  { id: "cred_vendor", organisation_id: "org_acme", connection_id: "conn_vendor", provider: "internal-vendor", kind: "api-key", display_name: "vendor-order-export", provider_id: "vendor_key_942", scopes: ["orders.read", "orders.export"], consumer_ids: ["svc_orders"], active_generation_id: "gen_vendor_3", policy_version: "policy_prod_v3", playbook_version: "play_vendor_v1", created_at: "2026-06-01T09:00:00Z", updated_at: "2026-08-10T11:00:00Z", revision: 3 },
  { id: "cred_github", organisation_id: "org_acme", connection_id: "conn_secrets", provider: "github", kind: "fine-grained-token", display_name: "deployment-release-token", provider_id: "gh_pat_2841", scopes: ["contents:read", "deployments:write"], consumer_ids: ["svc_webhooks"], active_generation_id: "gen_github_4", policy_version: "policy_prod_v3", playbook_version: "play_github_v2", created_at: "2026-04-01T09:00:00Z", updated_at: now, revision: 5 },
  { id: "cred_billing", organisation_id: "org_acme", connection_id: "conn_secrets", provider: "stripe", kind: "restricted-key", display_name: "billing-subscriptions", provider_id: "rk_live_3172", scopes: ["subscriptions.write", "invoices.read"], consumer_ids: ["svc_billing"], active_generation_id: "gen_billing_9", policy_version: "policy_finance_v2", playbook_version: "play_stripe_v2", created_at: "2026-03-12T09:00:00Z", updated_at: "2026-08-12T10:00:00Z", revision: 9 },
  { id: "cred_reconcile", organisation_id: "org_acme", connection_id: "conn_secrets", provider: "netsuite", kind: "oauth-client", display_name: "finance-reconciliation", provider_id: "oauth_client_992", scopes: ["transactions.read"], consumer_ids: ["svc_reconcile"], active_generation_id: "gen_reconcile_2", policy_version: "policy_finance_v2", playbook_version: "play_vendor_v1", created_at: "2026-07-02T09:00:00Z", updated_at: "2026-08-02T10:00:00Z", revision: 2 },
  { id: "cred_ingest", organisation_id: "org_acme", connection_id: "conn_secrets", provider: "segment", kind: "write-key", display_name: "production-event-ingest", provider_id: "segment_18f2", scopes: ["events.write"], consumer_ids: ["svc_ingest"], active_generation_id: "gen_ingest_6", policy_version: "policy_data_v1", playbook_version: "play_vendor_v1", created_at: "2026-02-10T09:00:00Z", updated_at: "2026-08-08T10:00:00Z", revision: 6 },
  { id: "cred_exports", organisation_id: "org_acme", connection_id: "conn_secrets", provider: "snowflake", kind: "key-pair", display_name: "warehouse-export-signer", provider_id: "snow_user_export", scopes: ["warehouse:use", "stage:write"], consumer_ids: ["svc_exports"], active_generation_id: "gen_exports_4", policy_version: "policy_data_v1", playbook_version: "play_vendor_v1", created_at: "2026-01-12T09:00:00Z", updated_at: "2026-08-01T10:00:00Z", revision: 4 },
]
...
export const runs = [
  {
    ...
    policy_version: "policy_prod_v3", dry_run_id: null, dry_run_playbook_id: null, stage: "approval", status: "paused",
    lease: null, fencing_token: 4, playbook_version: "play_sendgrid_v3", plan_id: "plan_sendgrid_42", plan_hash: hash("a"), current_generation_id: "gen_sendgrid_7", target_generation_id: "gen_sendgrid_8",
  ...
  },
  {
    ...
    policy_version: "policy_prod_v3", dry_run_id: null, dry_run_playbook_id: null, stage: "deploy", status: "running",
    lease: { owner_id: "actor_coordinator", fencing_token: 2, expires_at: "2026-08-16T18:10:00Z" }, fencing_token: 2, playbook_version: "play_github_v2", plan_id: "plan_github_91", plan_hash: hash("b"), current_generation_id: "gen_github_4", target_generation_id: "gen_github_5",
  ...
  },
  {
    ...
    policy_version: "policy_prod_v3", dry_run_id: null, dry_run_playbook_id: null, stage: "complete", status: "completed",
    lease: null, fencing_token: 3, playbook_version: "play_stripe_v2", plan_id: "plan_stripe_44", plan_hash: hash("c"), current_generation_id: "gen_stripe_4", target_generation_id: "gen_stripe_5",
  ...
  },
  {
    ...
    policy_version: "policy_data_v1", dry_run_id: null, dry_run_playbook_id: null, stage: "complete", status: "completed",
    lease: null, fencing_token: 3, playbook_version: "play_vendor_v1", plan_id: "plan_segment_18", plan_hash: hash("8"), current_generation_id: "gen_ingest_5", target_generation_id: "gen_ingest_6",
  ...
  },
  {
    ...
    policy_version: "policy_prod_v3", dry_run_id: null, dry_run_playbook_id: null, stage: "create", status: "failed",
    lease: null, fencing_token: 2, playbook_version: "play_vendor_v1", plan_id: "plan_vendor_12", plan_hash: hash("d"), current_generation_id: "gen_vendor_3", target_generation_id: null,
...
export const playbooks = [
  { id: "play_sendgrid", organisation_id: "org_acme", name: "SendGrid API key rotation", provider: "sendgrid", latest_version: 3, active_version_id: "play_sendgrid_v3", created_at: earlier, updated_at: now, revision: 4 },
  { id: "play_stripe", organisation_id: "org_acme", name: "Stripe restricted key rotation", provider: "stripe", latest_version: 2, active_version_id: "play_stripe_v2", created_at: earlier, updated_at: "2026-08-15T15:20:00Z", revision: 2 },
  { id: "play_github", organisation_id: "org_acme", name: "GitHub token rotation", provider: "github", latest_version: 2, active_version_id: "play_github_v2", created_at: earlier, updated_at: now, revision: 3 },
  { id: "play_vendor", organisation_id: "org_acme", name: "Vendor console credential rotation", provider: "internal-vendor", latest_version: 1, active_version_id: "play_vendor_v1", created_at: earlier, updated_at: "2026-08-10T11:00:00Z", revision: 1 },
]
...
export const agents = [
  ...
  { ...agentBase, id: "agent_playbook", kind: "playbook", display_name: "Playbook Builder Agent", skills: ["build_playbook", "analyse_walkthrough", "generate_dry_run"], identity: "agent-playbook@acme-prod.iam.gserviceaccount.com" },
...
const auditKinds = [
  ...
  ["playbook.bound", "actor_planner", "playbooks/play_github_v2", "run_github_schedule", { version: "play_github_v2" }],
