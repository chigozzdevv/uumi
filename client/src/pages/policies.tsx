...
export function PoliciesPage() {
  ...
  if (selected) return <div className="page">
    <PageHeader eyebrow="Policies" title={selected.name} onBack={() => setSelected(null)} />
  ...
  return <div className="page">
    <PageHeader title="Policies" actions={<Button onClick={() => setCreating(true)}><Plus className="size-3.5" /> Add policy</Button>} />
