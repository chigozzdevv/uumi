...
export function PoliciesPage() {
  ...
  return <div className="page">
    ...
    <Toolbar value={search} onChange={setSearch} placeholder="Search policies" onClear={() => { setSearch(""); setStatus("all") }} filters={[{ label: "Status", value: status, defaultValue: "all", onChange: (event) => setStatus(event.target.value), children: <><option value="all">All statuses</option><option value="active">Active</option><option value="draft">Draft</option></> }]} />
